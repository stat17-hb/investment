...
with st.expander("📖 표준편차 매매법이란?", expanded=False):
    ...
    **전일까지의 일일 표준편차** 대비 **당일 수익률**이 충분히 하락했을 때 매수합니다.

    - **1σ 매수**: 당일 수익률이 전일까지의 일일 표준편차 이상 하락 시 매수
      - 예시: 전일까지의 일일 표준편차가 3.0%이고, 당일 -3.0% 이상 하락 시
    - **2σ 매수**: 당일 수익률이 전일까지의 일일 표준편차의 2배 이상 하락 시 매수
      - 예시: 전일까지의 일일 표준편차가 3.0%이고, 당일 -6.0% 이상 하락 시
    - 통계적으로 1σ 매수는 연간 약 20회, 2σ 매수는 연간 약 10회 발생합니다
